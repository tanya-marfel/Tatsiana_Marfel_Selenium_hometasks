package com.epam.ftm.selenium.part2.chrome;
...
public class MailRuTestChrome {
	...
	private static final String PRESENCE = "//div[contains(text()," + "'" + SUBJECT + "'" + ")]";
	...
	private void draftExist() {
		...
		driver.findElement(By.xpath(PRESENCE)).click();
	}
	...
	private void verifyContent() throws IOException, InterruptedException {
		...
		draftsFolder.click();
		AssertJUnit.assertTrue(isElementPresent(By.xpath(currentUrl)));
	}
